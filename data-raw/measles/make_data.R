# Data from the South ----------------------------------------------------------
load("data-raw/Cases rest of VN.RData")
south35 <- a
rm(a)
...
north28 <- data.frame(read_excel("data-raw/Cases north VN.xlsx"))
...
# Provinces
codes <- read_excel("data-raw/GeoData.xlsx")
...
patch <- read.table("data-raw/patch.txt", TRUE, as.is = TRUE)
